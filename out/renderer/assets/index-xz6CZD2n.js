...
const PageControlPanel = () => {
  ...
  const [colorChange, setColorChanged] = reactExports.useState(false);
  const [colorChange2, setColorChanged2] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 d-flex justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, autoPlay: true, muted: true, style: { width: "480px" } }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 d-flex justify-content-center gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 d-flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Lamp Control" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleButton1Click,
            type: "button",
            className: colorChange ? "btn btn-danger px-3" : "btn btn-success px-3",
            children: colorChange ? "Off" : "On"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 d-flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Fan Control" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleButton2Click,
            type: "button",
            className: colorChange2 ? "btn btn-danger px-3" : "btn btn-success px-3",
            children: colorChange2 ? "Off" : "On"
          }
        )
      ] })
    ] })
...
const fart$1 = "" + new URL("fart-C8ugyAjD.mp3", import.meta.url).href;
const camera_click$1 = "" + new URL("camera-click-C84L_gho.mp3", import.meta.url).href;
const CameraCapture = ({ durian: durian2 }) => {
  const videoRef = reactExports.useRef(null);
  ...
  const sendDataToBackend = (imageData) => {
    if (durian2.nomor == "" && durian2.kematangan == "" && durian2.take == "") {
      let stop = new Audio(fart$1);
      stop.play();
      ...
      let audio = new Audio(camera_click$1);
      audio.play();
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, autoPlay: true, muted: true, style: { width: "640px" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-primary", onClick: captureImage, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { class: "fa-solid fa-camera" }),
      " Capture Image"
    ] }) })
  ] });
};
const rizz = "" + new URL("rizz-soe51pB2.mp3", import.meta.url).href;
const short_augh = "" + new URL("short-augh-DioC_BhL.mp3", import.meta.url).href;
const PageAmbilData = () => {
  const [nomor, setNomor] = reactExports.useState("");
  const [kematangan, setKematangan] = reactExports.useState("");
  const [take, setTake] = reactExports.useState("");
  reactExports.useState(false);
  reactExports.useState(false);
  const [tombolAroma, setTombolAroma] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "ambil-data", className: "mt-3 d-flex justify-content-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CameraCapture, { durian: { nomor, kematangan, take } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 d-flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Ambil Data Aroma" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: ambilDataAroma,
            type: "button",
            className: tombolAroma ? "btn btn-danger px-3" : "btn btn-success px-3",
            children: tombolAroma ? "Mengambil..." : "Ambil"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Nomor Durian" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            class: "form-control",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Tingkat Kematangan Buah Durian" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: "Open this select menu" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "matang", children: "matang" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "mentah", children: "mentah" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "luar dataset-matang", children: "luar dataset-matang" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "luar dataset-mentah", children: "luar dataset-mentah" })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Pengambilan ke-" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            class: "form-select",
...
function PageClassifier() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 d-flex justify-content-center  gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, autoPlay: true, muted: true, style: { width: "640px" } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "d-flex justify-content-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "btn btn-success", onClick: captureImage, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("i", { class: "fa-solid fa-camera" }),
        " Capture Image"
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex gap-2 align-items-center", style: buttonStyle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Ambil Data Aroma" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: cnnGasModel,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          style: buttonStyle,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Classify Durian" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: cnnClassify,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "CNN Gas Output : " }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "CNN Image Output : " })
      ] })
    ] })
  ] }) });
}
function App() {
  ...
  let gap = { gap: "20px" };
  const [currentPage, setCurrentPage] = reactExports.useState("page1");
  ...
  const renderPage = () => {
    switch (currentPage) {
      case "page1":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(PageAmbilData, {});
      case "page2":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(PageClassifier, {});
      case "page3":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(PageControlPanel, {});
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(PageAmbilData, {});
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "two-button-wrapper text-center", children: message }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "d-flex justify-content-center", style: gap, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleConnect, type: "button", class: "btn btn-danger", children: "Connect to Arduino" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAmbilData, type: "button", class: "btn btn-primary", children: "Ambil Data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
